...
describe('Image', () => {
  it.each([
    ...
    'width = "100" height = "50"',
    'stroke-width="4" viewBox="0 0 100 50"',
    'data-width="4" width="100" height="50"',
    'data-viewBox="0 0 4 2" viewBox="0 0 100 50"',
    "viewBox = '0 0 100 50'",
  ])('should read SVG dimensions from %s', async (attributes) => {
    const source = `<svg xmlns="http://www.w3.org/2000/svg" ${attributes}></svg>`
