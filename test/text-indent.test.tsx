	...
	it('should work correctly with positive pixel indent', async () => {
		const svg = await satori(
			...
			>
				...
				>
					This is a multiline text that should have the first line
	...
	it('should work correctly with negative indent (hanging indent)', async () => {
		const svg = await satori(
			...
			>
				...
				>
					This is a multiline text with hanging indent for the first
					line
				</div>
			</div>,
			{ width: 200, height: 200, fonts, embedFont: true }
	...
	it('should work correctly with percentage value', async () => {
		const svg = await satori(
			...
			>
				...
				>
					This text has a first line indented by 20% of container
					width
				</div>
			</div>,
			{ width: 200, height: 200, fonts, embedFont: true }
	...
	it('should work correctly with em units', async () => {
		const svg = await satori(
			...
			>
				...
				>
					This text has a first line indented by 2em (relative to font
					size)
				</div>
			</div>,
			{ width: 200, height: 200, fonts, embedFont: true }
	...
	it('should work correctly with text-align: right', async () => {
		const svg = await satori(
			...
			>
				...
				>
					This text is right-aligned and has an indent on the first
					line
				</div>
			</div>,
			{ width: 200, height: 200, fonts, embedFont: true }
	...
	it('should work correctly with text-align: justify', async () => {
		const svg = await satori(
			...
			>
				...
				>
					This text is justified and has an indent on the first line
					only
				</div>
			</div>,
			{ width: 200, height: 200, fonts, embedFont: true }
	...
	it('should override inherited value', async () => {
		const svg = await satori(
			...
			>
				...
				>
					This text overrides the inherited text-indent with a smaller
					value
				</div>
			</div>,
			{ width: 200, height: 200, fonts, embedFont: true }
