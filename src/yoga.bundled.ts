...
// in a serverless function), only one yoga.wasm instantiation runs. Two
// simultaneous instantiations have been observed to deadlock on
// memory-constrained serverless runtimes like Vercel/AWS Lambda.
